...
import org.flinkhub.messenger2.LocationController;
...
import org.flinkhub.messenger2.camera.CameraController;
import org.telegram.tgnet.ConnectionsManager;
import org.telegram.tgnet.TLRPC;
import org.flinkhub.messenger2.UserConfig;
import org.flinkhub.ui.ActionBar.AlertDialog;
import org.flinkhub.ui.Adapters.DrawerLayoutAdapter;
import org.flinkhub.ui.ActionBar.ActionBarLayout;
import org.flinkhub.ui.ActionBar.BaseFragment;
import org.flinkhub.ui.ActionBar.DrawerLayoutContainer;
import org.flinkhub.ui.Cells.DrawerAddCell;
import org.flinkhub.ui.Cells.DrawerUserCell;
import org.flinkhub.ui.Cells.LanguageCell;
import org.flinkhub.ui.Cells.ThemesHorizontalListCell;
import org.flinkhub.ui.Components.AudioPlayerAlert;
import org.flinkhub.ui.Components.AlertsCreator;
import org.flinkhub.ui.Components.BlockingUpdateView;
...
import org.flinkhub.ui.Components.PasscodeView;
import org.flinkhub.ui.Components.PipRoundVideoView;
import org.flinkhub.ui.Components.RecyclerListView;
import org.flinkhub.ui.Components.SharingLocationsAlert;
import org.flinkhub.ui.Components.StickersAlert;
import org.flinkhub.ui.ActionBar.Theme;
import org.flinkhub.ui.Components.TermsOfServiceView;
import org.flinkhub.ui.Components.ThemeEditorView;
import org.flinkhub.ui.Components.UpdateAppAlertDialog;
...
public class LaunchActivity extends Activity implements ActionBarLayout.ActionBarLayoutDelegate, NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Tracker.createInstance(this, getApplicationContext());
        ...
        sideMenu.setOnItemClickListener((view, position) -> {
            if (position == 0) {
                ...
                if (id == 2) {
                    ...
                    try {
                        Intent openChat = new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.FEEDBACK_GROUP_LINK));
        ...
        NotificationCenter.getGlobalInstance().addObserver(this, NotificationCenter.fhUserInfoDidLoad);
        ...
        Tracker.setScreenName("LaunchActivity");
    }
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || SharedConfig.isWaitingForPasscodeEnter)) {
            ...
            if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("org.flinkhub.messenger2.OPEN_ACCOUNT")) {
                        open_settings = 1;
    ...
    public void checkAppUpdate(boolean force) {
        ...
        // Flinkhub: Do not check telegram server for updates
...
//        });
    ...
    private void onFinish() {
        ...
        NotificationCenter.getGlobalInstance().removeObserver(this, NotificationCenter.fhUserInfoDidLoad);
    }
