...
public class DrawerLayoutAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public void setUserData(UserDataObj fhUserData) {
...
//        }
    ...
    private void resetItems() {
        ...
        if (eventType == 0) {
            items.add(new Item(12, LocaleController.getString("UserProfileHeading", R.string.UserProfileHeading), R.drawable.menu_contacts_ny));

            items.add(new Item(14, LocaleController.getString("MenuJoinAlumniGroups", R.string.MenuJoinAlumniGroups), R.drawable.menu_feedback_ny));
...
//            items.add(new Item(9, LocaleController.getString("TelegramFAQ", R.string.TelegramFAQ), R.drawable.menu_help_ny));
            items.add(new Item(13, LocaleController.getString("MenuFlinkhubCommunity", R.string.MenuFlinkhubCommunity), R.drawable.menu_feedback_ny));
        } else {
            items.add(new Item(12, LocaleController.getString("UserProfileHeading", R.string.UserProfileHeading), R.drawable.menu_contacts_ny));
