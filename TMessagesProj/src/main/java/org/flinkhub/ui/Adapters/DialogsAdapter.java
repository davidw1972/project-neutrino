...
import org.flinkhub.ui.Cells.ArchiveHintCell;
import org.flinkhub.ui.Cells.DialogCell;
import org.flinkhub.ui.Cells.DialogMeUrlCell;
...
import org.flinkhub.ui.DialogsActivity;
...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public DialogsAdapter(Context context, int type, int folder, boolean onlySelect, UserDataObj fhUserData, View.OnClickListener listener) {
        mContext = context;
        dialogsType = type;
        folderId = folder;
    ...
    public void setFhUserData(UserDataObj fhUserData) {
        this.fhUserData = fhUserData;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
        switch (holder.getItemViewType()) {
            ...
            case 5: {
                ...
                cell.setOnCTAClickListener(listener);
                break;
            }
            case 4: {
