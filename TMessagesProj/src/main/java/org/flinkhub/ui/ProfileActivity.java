...
import org.flinkhub.ui.Cells.AboutLinkCell;
...
import org.flinkhub.ui.Cells.NotificationsCheckCell;
...
import org.flinkhub.ui.Components.IdenticonDrawable;
...
import org.flinkhub.ui.Components.ScamDrawable;
...
public class ProfileActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate {
    ...
    private int flinkhubInfoLoadingRow;
...
//        Log.d("USERID", Integer.toString(user_id));
        ...
        if (user_id != 0) {
            ...
            Tracker.setScreenName("ChatDetails");
        } else {
            return false;
        }
    ...
    private void updateRowsIds() {
        ...
        if (user_id != 0) {
            if (fhUserData == null) {
                // flinkhubInfoLoadingRow = rowCount++;
            } else {
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
                ...
                case 2:
                    ...
                    if (position == phoneRow) {
                        ...
                        if (user_id != 0) {
                            ...
                            TLRPC.Chat chat = MessagesController.getInstance(currentAccount).getChat(chat_id);
                            detailCell.setTextAndValue(MessagesController.getInstance(currentAccount).linkPrefix + "/" + chat.username, LocaleController.getString("InviteLink", R.string.InviteLink), true);
                        }
                    } else if (position == locationRow) {
                        ...
                        if (fhUserData != null) {
                            detailCell.setTextAndValue(fhUserData.getLocationStr(), LocaleController.getString("UserCityName", R.string.UserCityName), false);
                        }
                    }
                    break;
                case 3:
        ...
        public int getItemViewType(int i) {
            if (
                    i == infoHeaderRow || i == sharedHeaderRow ||
                            i == membersHeaderRow || i == educationHeaderRow ||
                            i == experienceHeaderRow
            ) {
                return 1;
            } else if (i == phoneRow || i == usernameRow || i == locationRow || i == cityRow) {
                return 2;
            } else if (i == educationListRow || i == experienceListRow) {
                return 12;
                ...
                return 6;
                    ...
                    i == infoSectionRow || i == sharedSectionRow ||
                            i == lastSectionRow || i == membersSectionRow || i == settingsSectionRow ||
                            i == educationSectionRow || i == experienceSectionRow
            ) {
                return 7;
            } else if (i >= membersStartRow && i < membersEndRow) {
                return 8;
            } else if (i == emptyRow || i == flinkhubInfoLoadingRow) {
                return 11;
            }
            return 0;
        }
