...
public class ManageExperienceActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ExperienceCell.EditExperienceHandler {
    private View addButton;
    private final static int add_button = 1;
    private UserDataObj fhUserData = null;
    private ExperienceCell expListView;

    public ManageExperienceActivity(UserDataObj fhUserData) {
        super();
...
//        fragmentView.setOnTouchListener((v, event) -> true);
        ...
        expListView.setData(fhUserData.getExperience());
    ...
    public void deleteClicked(Experience experience) {
        // TODO Show alert
        Log.e(Constants.TAG, "User wants to delete experience");
        ...
        (new Thread(() -> {
            UserDataObj result = UserData.deleteExperience(fhUserData.getUser_id(), experience.getId());
