...
import org.flinkhub.messenger2.BuildConfig;
import org.flinkhub.messenger2.BuildVars;
import org.flinkhub.messenger2.ChatObject;
import org.flinkhub.messenger2.MediaDataController;
import org.flinkhub.messenger2.Emoji;
...
import org.flinkhub.messenger2.browser.Browser;
import org.flinkhub.messenger2.support.SparseLongArray;
import org.flinkhub.messenger2.ApplicationLoader;
import org.flinkhub.messenger2.FileLoader;
import org.telegram.tgnet.ConnectionsManager;
import org.telegram.tgnet.TLObject;
import org.telegram.tgnet.TLRPC;
import org.flinkhub.messenger2.ContactsController;
...
import org.flinkhub.ui.ActionBar.ActionBarLayout;
import org.flinkhub.ui.ActionBar.ActionBarPopupWindow;
import org.flinkhub.ui.ActionBar.AlertDialog;
import org.flinkhub.ui.ActionBar.BackDrawable;
import org.flinkhub.ui.ActionBar.BottomSheet;
import org.flinkhub.ui.ActionBar.SimpleTextView;
import org.flinkhub.ui.ActionBar.ThemeDescription;
import org.flinkhub.ui.Adapters.MentionsAdapter;
import org.flinkhub.ui.Adapters.StickersAdapter;
import org.flinkhub.ui.Cells.BotSwitchCell;
import org.flinkhub.ui.Cells.ChatActionCell;
import org.flinkhub.ui.Cells.ChatLoadingCell;
...
import org.flinkhub.ui.Cells.ChatMessageCell;
import org.flinkhub.ui.Cells.ChatUnreadCell;
import org.flinkhub.ui.Cells.CheckBoxCell;
import org.flinkhub.ui.Cells.ContextLinkCell;
import org.flinkhub.ui.Cells.MentionCell;
import org.flinkhub.ui.ActionBar.ActionBarMenuSubItem;
import org.flinkhub.ui.Cells.StickerCell;
import org.flinkhub.ui.Components.AlertsCreator;
import org.telegram.ui.Components.AnimatedFileDrawable;
import org.flinkhub.ui.Components.AnimationProperties;
import org.flinkhub.ui.Components.BackupImageView;
import org.flinkhub.ui.ActionBar.BaseFragment;
import org.flinkhub.ui.Cells.BotHelpCell;
import org.flinkhub.ui.Components.ChatActivityEnterView;
import org.flinkhub.messenger2.ImageReceiver;
import org.flinkhub.ui.Components.ChatAttachAlert;
import org.flinkhub.ui.Components.ChatAvatarContainer;
import org.flinkhub.ui.Components.ChatBigEmptyView;
import org.flinkhub.ui.Components.CombinedDrawable;
import org.flinkhub.ui.Components.CorrectlyMeasuringTextView;
import org.flinkhub.ui.Components.EditTextCaption;
import org.flinkhub.ui.Components.EmbedBottomSheet;
import org.flinkhub.ui.Components.EmojiView;
import org.flinkhub.ui.Components.ExtendedGridLayoutManager;
import org.flinkhub.ui.Components.FragmentContextView;

import androidx.recyclerview.widget.GridLayoutManagerFixed;

import org.flinkhub.ui.Components.InstantCameraView;
import org.flinkhub.ui.Components.LayoutHelper;
import org.flinkhub.ui.Components.HintView;
import org.flinkhub.ui.Components.NumberTextView;
...
import org.flinkhub.ui.Components.ShareAlert;
import org.flinkhub.ui.Components.Size;
import org.flinkhub.ui.Components.SizeNotifierFrameLayout;
import org.flinkhub.ui.Components.StickersAlert;
import org.flinkhub.ui.ActionBar.Theme;
import org.flinkhub.ui.Components.TextStyleSpan;
import org.flinkhub.ui.Components.TypefaceSpan;
import org.flinkhub.ui.Components.URLSpanBotCommand;
import org.flinkhub.ui.Components.URLSpanMono;
import org.flinkhub.ui.Components.URLSpanNoUnderline;
import org.flinkhub.ui.Components.URLSpanReplacement;
import org.flinkhub.ui.Components.URLSpanUserMention;
import org.flinkhub.ui.Components.UndoView;
...
public class ChatActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, LocationActivity.LocationActivityDelegate {
    ...
    public boolean onFragmentCreate() {
        ...
        Tracker.setScreenName("ChatActivity");
        return true;
    }
        ...
        if (which == attach_photo) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                if (getParentActivity().checkSelfPermission(Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
                    // Flinkhub: Remove contact permission prompt
        ...
        if (id == NotificationCenter.messagesDidLoad) {
            ...
            if (guid == classGuid) {
                ...
                for (int a = 0; a < messArr.size(); a++) {
                    ...
                    // Flinkhub: Hiding user joined and left notifications
//                    if (
//                            (chatInfo != null && chatInfo.participants_count > 100) &&
//                            obj.messageOwner.action instanceof TLRPC.TL_messageActionChatJoinedByLink ||
...
//                    }
    ...
    public void showOpenUrlAlert(final String url, boolean ask) {
        ...
        } else if (Browser.isFlinkhubUri(url)) {
            Browser.openUrl(getParentActivity(), url, inlineReturn == 0);
        } else {
            if (getParentActivity() == null) {
                return;
                    ...
                    if ((index = animatingMessageObjects.indexOf(message)) != -1) {
                        ...
                        messageCell.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                            ...
                            public boolean onPreDraw() {
                                ...
                                org.flinkhub.ui.Components.Rect rect = instantCameraView.getCameraRect();
