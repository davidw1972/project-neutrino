...
package org.flinkhub.messenger2.camera;
...
public class CameraView extends FrameLayout implements TextureView.SurfaceTextureListener {
    ...
    private void initCamera() {
        ...
        org.flinkhub.messenger2.camera.Size aspectRatio;
        int wantedWidth;
        int wantedHeight;
        if (initialFrontface) {
        ...
        org.flinkhub.messenger2.camera.Size pictureSize = CameraController.chooseOptimalSize(info.getPictureSizes(), wantedWidth, wantedHeight, aspectRatio);
        if (pictureSize.getWidth() >= 1280 && pictureSize.getHeight() >= 1280) {
            ...
            org.flinkhub.messenger2.camera.Size pictureSize2 = CameraController.chooseOptimalSize(info.getPictureSizes(), wantedHeight, wantedWidth, aspectRatio);
